...
add_action('after_switch_theme', 'create_custom_contact_table');
...
add_action('wp_ajax_handle_custom_contact_form_inline', 'handle_custom_contact_form_inline');
add_action('wp_ajax_nopriv_handle_custom_contact_form_inline', 'handle_custom_contact_form_inline');

function handle_custom_contact_form_inline() {
    global $wpdb;
    ...
    echo 'Thank you! Your message has been sent.';
    wp_die(); // Required to end AJAX response
}
